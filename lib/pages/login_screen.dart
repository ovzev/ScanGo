...
import 'home_screen.dart'; // استبدلها بالصفحة التي تريد الانتقال لها بعد تسجيل الدخول
  ...
  Future<void> _signIn(BuildContext context) async {
    try {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => HomeScreen()), // غير الصفحة هنا إذا احتجت
      );
          ...
          children: [
            ...
            TextSpan(
              ...
              recognizer: TapGestureRecognizer()
                ..onTap = () {
                  Navigator.pushNamed(context, '/register'); // أو ضع الصفحة مباشرة
                },
            ),
          ],
        ),
